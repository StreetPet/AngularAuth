...
import { DashboardComponent, IDashboardComponent } from './dashboard/dashboard.component';
...
const routes: Routes = [
   ...
   {
      path: AuthService.DASHBOARD_ROUTER_NAME,
      loadChildren: './dashboard/dashboard.routes#DashboardRoutes',
